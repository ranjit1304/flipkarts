...
<title>Flipkarts - Online shopping platform & Retail marketing</title>
<link rel="stylesheet"
...
<body>
	...
	<div class="container">
		...
		<header>
			<h1>Flipkarts Online shopping Platform & Retail marketing</h1> 
		...
		<div id="tabs">
			...
			<li><a href="#tabs-1">Search</a></li>
				<li><a href="#tabs-2">Kart</a></li>
				<li><a href="#tabs-3">Payment gateway</a></li>
